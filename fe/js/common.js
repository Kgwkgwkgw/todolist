window.common = (function ($){
  ...
  var addEventHandling = function(arrEventInfo) {
  ...
  var render = function($parent, $child, isReset) {
  ...
  var popup = function(title, content, close_text) {
    title = title || "알림";
  ...
  // ajax 호출 실패 시 팝업 노출
  var handlingAjaxError = function() {
